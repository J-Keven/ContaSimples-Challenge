...
import ListAllCompanyTransactionsInMonthFIlteringTypeService from '@modules/transactions/services/ListAllCompanyTransactionsInMonthFilteringTypeService';
...
let listAllTransactionsFilteringByDateAndType: ListAllCompanyTransactionsInMonthFIlteringTypeService;

describe('ListAllCompanyTransactionsInMonthFIlteringType', () => {
  beforeEach(() => {
    fakeComapanyRepository = new FakeCompanyRepository();
    fakeTransacionRepository = new FakeTransactionRepository();
    listAllTransactionsFilteringByDateAndType = new ListAllCompanyTransactionsInMonthFIlteringTypeService(
  ...
  it('should be able to return all transactions on the day and filtered by type "credit"', async () => {
    ...
    jest
      .spyOn(Date, 'now')
      .mockImplementationOnce(() => new Date(2020, 10, 16).getTime());
